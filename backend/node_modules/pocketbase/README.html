...
<span class="nx">data</span><span class="p">.</span><span class="nx">set</span><span class="p">(</span><span class="s2">&quot;title&quot;</span><span class="p">,</span> <span class="s2">&quot;lorem ipsum...&quot;</span><span class="p">)</span>
<span class="nx">data</span><span class="p">.</span><span class="nx">set</span><span class="p">(</span><span class="s2">&quot;document&quot;</span><span class="p">,</span> <span class="k">new</span> <span class="nx">File</span><span class="p">(...))</span>

<span class="nx">await</span> <span class="nx">pb</span><span class="p">.</span><span class="nx">collection</span><span class="p">(</span><span class="s2">&quot;example&quot;</span><span class="p">).</span><span class="nx">create</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span>
</pre></div></p>
</li>
<li>
<p>Using plain object as body <em>(this is the same as above and it will be converted to <code>FormData</code> behind the scenes)</em>:
  ...
  <span class="s2">&quot;title&quot;</span><span class="o">:</span>    <span class="s2">&quot;lorem ipsum...&quot;</span><span class="p">,</span>
  <span class="s2">&quot;document&quot;</span><span class="o">:</span> <span class="k">new</span> <span class="nx">File</span><span class="p">(...),</span>
<span class="p">};</span>
...
<span class="kr">const</span> <span class="nx">store</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">AsyncAuthStore</span><span class="p">({</span>
    ...
    <span class="nx">initial</span><span class="o">:</span> <span class="nx">await</span> <span class="nx">AsyncStorage</span><span class="p">.</span><span class="nx">getItem</span><span class="p">(</span><span class="s1">&#39;pb_auth&#39;</span><span class="p">),</span>
<span class="p">});</span>
